...
function Datepicker() {
	...
	this._currentClass = "ui-datepicker-current-dayd"; // The name of the current day marker class
...
$.extend( Datepicker.prototype, {
	...
	_generateHTML: function( inst ) {
		...
		prev = ( this._canAdjustMonth( inst, -1, drawYear, drawMonth ) ?
			...
			" title='" + prevText + "'><img  src='img/left.png'><span onclick='pre("+drawYear+")' class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "e" : "w" ) + "'>" + prevText + "</span></a>" :
		...
		next = ( this._canAdjustMonth( inst, +1, drawYear, drawMonth ) ?
			...
			" title='" + nextText + "'><img  src='img/right.png'><span onclick='nxt("+drawYear+")' class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "w" : "e" ) + "'>" + nextText + "</span></a>" :
